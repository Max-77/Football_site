...
const list = videos.map((video) =>
    ...
    <form method="POST" action={str+name_videos[i]}>
        <div className="rating">
            <input type="radio" id={"star-5-"+i} name={"user_rating"} value="5"/>
            <label htmlFor={"star-5-"+i} title="Оценка «5»"></label>
            <input type="radio" id={"star-4-"+i} name={"user_rating"} value="4"/>
            <label htmlFor={"star-4-"+i} title="Оценка «4»"></label>
            <input type="radio" id={"star-3-"+i} name={"user_rating"} value="3"/>
            <label htmlFor={"star-3-"+i} title="Оценка «3»"></label>
            <input type="radio" id={"star-2-"+i} name={"user_rating"} value="2"/>
            <label htmlFor={"star-2-"+i} title="Оценка «2»"></label>
            <input type="radio" id={"star-1-"+i} name={"user_rating"} value="1"/>
